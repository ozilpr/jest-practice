...
describe('A MathBasic', () => {
  it('should be contains add, subtract, multiply, and divide function', () => {
  ...
  describe('A add function', () => {
    ...
    it('should return a + b when given two number parametes', () => {
  ...
  describe('A multiply function', () => {
    ...
    it('should return a * b when given two number parametes', () => {
      ...
      expect(MathBasic.multiply(16, 2)).toEqual(32);
  ...
  describe('A divide function', () => {
    ...
    it('should return a / b when given two number parametes', () => {
      ...
      expect(MathBasic.divide(16, 2)).toEqual(8);
      expect(MathBasic.divide(14, 7)).toEqual(2);
    });
  });
});
